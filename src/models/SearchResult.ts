...
const typeMap: any = {
  ...
  Hit: o(
    [
      ...
      { json: "videoTitle", js: "videoTitle", typ: "" },
      { json: "videoPublishDate", js: "videoPublishDate", typ: Date },
      { json: "videoViewCount", js: "videoViewCount", typ: 0 },
      { json: "videoLastUpdate", js: "videoLastUpdate", typ: Date },
      { json: "highlightedText", js: "highlightedText", typ: "" },
    ],
    false
  ),
};
